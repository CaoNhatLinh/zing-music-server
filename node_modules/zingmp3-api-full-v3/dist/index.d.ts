declare class ZingMp3Api {
    ...
    getListArtistPlaylist(artistId: string, page: string, count: string): Promise<any>;
    getSongsByArtistName(name: string, page: string, count: string): Promise<any>;
    getPlaylistsByArtistName(name: string, page: string, count: string): Promise<any>;
    getVideosByArtistName(name: string, page: string, count: string): Promise<any>;
    Suggest(): Promise<any>;
