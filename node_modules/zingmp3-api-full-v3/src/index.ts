...
class ZingMp3Api {
  ...
  public getListArtistPlaylist(artistId: string, page: string, count: string): Promise<any> {
    return new Promise<any>((resolve, rejects) => {
  ...
  public getSongsByArtistName(name: string ,page: string, count: string): Promise<any> {
    return new Promise<any>((resolve, rejects) => {
  ...
  public getPlaylistsByArtistName(name: string ,page: string, count: string): Promise<any> {
    return new Promise<any>((resolve, rejects) => {
      this.requestZingMp3("/api/v2/search", {
        q: name,
        type: "playlist",
  ...
  public getVideosByArtistName(name: string ,page: string, count: string): Promise<any> {
    return new Promise<any>((resolve, rejects) => {
      this.requestZingMp3("/api/v2/search", {
        q: name,
        type: "video",
